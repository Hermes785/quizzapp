...
const QuizzApp = () => {
        ...
        for (let i = startIndex; i < endIndex; i++) {
            ...
            if (selectedAnswer !== null) {
                if (selectedAnswer.isCorrect) {
                    ...
                    setAffiche(<span style={{ color: 'green' }}> "{selectedAnswer.answerText}" is  correct.</span>);
                } else {
                    setAffiche(
                        <div>
    ...
    // Dans le retour du composant, associez cette fonction au bouton "Vérifier les réponses"
            ...
            {!showScore ? (
                ...
                <>
                    {questions.slice(currentPage * questionsPerPage, (currentPage + 1) * questionsPerPage).map((question, questionIndex) => (
                        <div key={currentPage * questionsPerPage + questionIndex} className="card mb-3">
